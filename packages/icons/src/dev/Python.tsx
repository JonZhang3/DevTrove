...
export default function PythonIcon({ pure = true, ...rest }: IconProps) {
  return pure ? <PurePythonIcon {...rest} /> : <ColorfulPythonIcon {...rest} />;
}
