...
export default function ReactIcon({ pure = true, ...props }: IconProps) {
  return pure ? <PureReactIcon {...props} /> : <ColorfulReactIcon {...props} />;
}
