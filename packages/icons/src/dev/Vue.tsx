...
export default function VueIcon({ pure = true, ...props }: IconProps) {
  return pure ? <PureVueIcon {...props} /> : <ColorfulVueIcon {...props} />;
}
