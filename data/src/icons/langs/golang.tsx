...
export default function GolangIcon({
  ...
  if (wordmark) {
    return <WordmarkGolangIcon {...rest} />;
  }
  return pure ? <PureGolangIcon {...rest} /> : <ColorfulGolangIcon {...rest} />;
}
